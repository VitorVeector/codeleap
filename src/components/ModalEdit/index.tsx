...
import { ActuallyPost } from "context/DataContext";
...
export const ModalEdit = () => {   
    ...
    const onSubmit = ({title, content}: FormValues) => {
        try {
                    ...
                    <ModalBox>
                        ...
                        <FormEdit onSubmit={handleSubmit(onSubmit)}>
                            <Input
                                ...
                                type="text"
                                label="Title"
                                defaultValue={actuallyPost.title}
                            ...
                            <Input
                                ...
                                type="textarea"
                                label="Content"
                                defaultValue={actuallyPost.content}
